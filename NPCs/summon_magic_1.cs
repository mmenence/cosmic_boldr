...
{
    public class summon_magic_1 : ModNPC
    {
        public override void SetStaticDefaults() { 

            DisplayName.SetDefault("The new boulder");
        }
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                move_towards(npc, target, (float)((int)Vector2.Distance(target, npc.Center) > 2000 ? 30f : 5f), 0f);
                ...
                else if ((NPC.AnyNPCs(mod.NPCType("summon_ranged_1")) || NPC.AnyNPCs(mod.NPCType("summon_melee_1"))) && attack_timer > 120)
                {
                    attack_timer = 60;
                }
