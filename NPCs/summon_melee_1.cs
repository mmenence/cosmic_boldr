...
{
    public class summon_melee_1 : ModNPC
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("The first boulder");
        }
        ...
        public override void AI()
        {
            ...
            if(NPC.AnyNPCs(mod.NPCType("summon_ranged_1")) && NPC.AnyNPCs(mod.NPCType("summon_magic_1")) && attack_timer > 214)
            {
                attack_timer = 0;
            }

            else if ((NPC.AnyNPCs(mod.NPCType("summon_ranged_1")) || NPC.AnyNPCs(mod.NPCType("summon_magic_1"))) && attack_timer > 214)
            {
                attack_timer = 45;
            }
