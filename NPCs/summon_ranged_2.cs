...
{
    public class summon_ranged_2 : ModNPC
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("The second boulder, Reborn");
        }
        ...
        public override void AI()
        {
            ...
            if(NPC.AnyNPCs(mod.NPCType("summon_melee_2")) && NPC.AnyNPCs(mod.NPCType("summon_magic_2")) && attack_timer > 180)
            {
                attack_timer = 0;
            }

            else if ((NPC.AnyNPCs(mod.NPCType("summon_melee_2")) || NPC.AnyNPCs(mod.NPCType("summon_magic_2"))) && attack_timer > 180)
            {
                attack_timer = 60;
                npc.defense = 75;
            }
